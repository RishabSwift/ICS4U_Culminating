...
public class GameStage extends Stage {
    ...
    /**
     * This constructor is responsible for setting variables to start the scene for the game
     */
    GameStage() {
        ...
        // Progress bar for health for enemy and player
        ...
        // Start the service so that progress bar is binded to the health of emeny/user
    ...
    /**
     * Bind enemy health to the progress bar so it updates in real time
     */
    ...
    /**
     * Bind player health to the progress bar so it updates in real time
     */
